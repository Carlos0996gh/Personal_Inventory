...
class Platform(models.Model):
    ...
    platform_release_year = models.IntegerField(null=True)
...
class Developer(models.Model):
    ...
    developer_location = models.CharField(max_length = 200, null=True)
    developer_fundation_year = models.IntegerField(null=True)
...
class Publisher(models.Model):
    ...
    publisher_location = models.CharField(max_length = 200, null=True)
    publisher_fundation_year = models.IntegerField(null=True)
...
class Game_Genre(models.Model):
    ...
    desc_genre = models.CharField(max_length = 300, null=True)
...
class Game(models.Model):
    ...
    genre_name = models.ForeignKey(Game_Genre, null=True, on_delete=models.CASCADE)
    game_cover = models.CharField(max_length = 200)
    purchase_price = models.FloatField()
    game_purchase_date = models.DateField()
    game_status = models.ForeignKey(Game_Status, null=True, on_delete=models.CASCADE)
    game_format = models.ForeignKey(Game_Format, null=True, on_delete=models.CASCADE)
    purchase_status = models.ForeignKey(Purchase_Status, null=True, on_delete=models.CASCADE)
